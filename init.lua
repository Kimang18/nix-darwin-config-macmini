...
require("lazy").setup({
			...
			-- setup blink cmp
			{
				...
				opts = {
					...
					keymap = {
						...
						-- ["<C-b>"] = false, -- disable C-b from active
						-- ["<C-f>"] = false, -- disable C-f from active
						-- ["<C-k>"] = false, -- disable C-k from active
					},
					appearance = {
	...
	-- setup vimtex
	{
		...
		init = function()
			...
			-- vim.g.vimtex_view_general_viewer = "open -a Preview.app"
